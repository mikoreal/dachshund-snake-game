...
export class View {
    ...
    render(food, snake, score, bestScore) {
        ...
        this.context.strokeStyle = '#a678f0'
        this.context.beginPath()
        snake
        ...
        const snakeHead = this.projectPosition(snake[snake.length - 1])
        this.context.fillStyle = '#2ecc71'; // Color for the snake's head
        this.context.fillRect(
            snakeHead.x - this.unitOnScreen / 2,
            snakeHead.y - this.unitOnScreen / 2,
            this.unitOnScreen,
            this.unitOnScreen
        );
